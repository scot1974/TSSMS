...
<div class="card bg-light mb-3" style="max-width: 25rem; float: right; margin-top: 50px;">
  ...
  <div class="card-body">
    <h5 class="card-title">Eligibility and Requirements.</h5>
    <p class="card-text">To qualify for the 2019 Taraba State government Scholarship Award Scheme, applicants must;</p>
    <li>Be Taraba State indigene</li>
    <li>Have Five (5) credit grades in WASC/GCE/SSCE including Maths, English and 3 other relevant subjects obtained in one sitting.</li>
    <li>For undergraduate students, applicant must be a full-time (100 LEVEL) degree students of the under-listed courses in Taraba State (Taraba State Polytecnic, Federal University Wukari, Kwararafa University, Taraba State University).</li>
  </div>
</div>
<div class="container-fluid">
  <div class="list-group" style="float: left; margin-top: 50px; margin-left: 30px; width: 30%; " id="list">
  <h5 class="list-group-item list-group-item-dark">FRSC News</h5>
...
<div class="container-fluid">
  ...
  <a href="#" class="list-group-item list-group-item-action">FRSC Procurement Activities</a>
  <a href="#" class="list-group-item list-group-item-action">Morbi leo risus</a>
  <a href="#" class="list-group-item list-group-item-action">Porta ac consectetur ac</a>
</div>
</div>
<div class="container-fluid">
  <div class="list-group" style="float: left; margin-top: 10px; margin-left: 30px; width: 30%; " id="list">
  <h5 class="list-group-item list-group-item-dark">Ministries</h5>
    
  </a>
  <a href="#" class="list-group-item list-group-item-action">Ministry of Agriculture</a>
  <a href="#" class="list-group-item list-group-item-action">Commerce &amp; Industry</a>
  <a href="#" class="list-group-item list-group-item-action">Women Affairs &amp; Child Devt.</a>
</div>
</div>
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="section-header">
        <h2>Our Servies</h2>
        <p>Some of our recent works that we have finished so far</p>
      </div>
    </div>
  </div>
  <div class="row">
    <div class="col-md-4">
      <div class="single-service">
        ...
        <p>Taraba State was created on August 27th, 1991 when the Babangida Military Administration carved it out of the defunct Gongola State.
        The State derives its name from one of the three major rivers and covers a land area of 59,400 square kilometres.
        </p>
    ...
    <div class="container">
      <div class="row">
        <div class="col-md-3 col-sm-6 col-xs-12 segment-one">
          ...
          <p id="p">Some of our recent works that we have finished so far
          Some of our recent works that we have finished so far
          Some of our recent works that we have finished so far
          Some of our recent works that we have finished so far</p> 
        </div>
