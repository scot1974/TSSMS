...
--
-- Host: 127.0.0.1
-- Generation Time: Oct 07, 2019 at 07:26 PM
...
(1, 'Alison', '0000-00-00', 940000, 169200, 500, 1108700, 1108700, 0, 'Cash'),
(2, 'Ezra ', '2019-03-10', 490000, 88200, 500, 577700, 577700, 0, 'Cash'),
(3, 'Scot Ezra Jnr', '2019-03-10', 620000, 111600, 50, 731550, 731550, 0, 'Cash');
...
(1, 2, 'Samsung Galaxy S9', 90000, 1),
(2, 2, 'Photoshop CS6', 50000, 1),
(3, 2, 'iPhone 11 Pro', 350000, 1),
(4, 3, 'Samsung LED Smart TV', 120000, 1),
(5, 3, 'Apple Laptop', 500000, 1);
...
(1, 2, 1, 'Samsung Galaxy S9', 90000, 999, '2019-09-22', '1'),
(2, 3, 3, 'Photoshop CS6', 50000, 1499, '2019-09-20', '1'),
(3, 1, 6, 'Pavillion', 200000, 5000, '2019-09-23', '1'),
(4, 2, 8, 'iPhone 11 Pro', 350000, 999, '2019-09-23', '1'),
(5, 1, 8, 'Apple Laptop', 500000, 1499, '2019-09-23', '1'),
(6, 1, 6, 'HP Pavilion', 250000, 3000, '2019-09-23', '1'),
(7, 7, 1, 'Samsung LED Smart TV', 120000, 1999, '2019-09-23', '1');
...
(4, 'root', 'server', 'ambulance', '{"quick_or_custom":"quick","what":"sql","db_select[]":["accidentrecord","ambulance","apfsystem","attendance_system","bbms","bookshop","company","cs192upsms","cybercrimedatabase","database","ecommerce-mary","elimtop","expert","expert2018","frsc_database","frscdb","health","hmsdb","hostel_management_system","intprof","inv_project_db","lmsdb","nafdac","pending","phpmyadmin","project_inv","registration","scheduling","scholardb","scholarship","scholarshipdb","shop","sms","tssmsdb"],"output_format":"sendit","filename_template":"@SERVER@","remember_template":"on","charset":"utf-8","compression":"none","maxsize":"","codegen_structure_or_data":"data","codegen_format":"0","csv_separator":",","csv_enclosed":"\\"","csv_escaped":"\\"","csv_terminated":"AUTO","csv_null":"NULL","csv_structure_or_data":"data","excel_null":"NULL","excel_edition":"win","excel_structure_or_data":"data","htmlword_structure_or_data":"structure_and_data","htmlword_null":"NULL","json_structure_or_data":"data","latex_caption":"something","latex_structure_or_data":"structure_and_data","latex_structure_caption":"Structure of table @TABLE@","latex_structure_continued_caption":"Structure of table @TABLE@ (continued)","latex_structure_label":"tab:@TABLE@-structure","latex_relation":"something","latex_comments":"something","latex_mime":"something","latex_columns":"something","latex_data_caption":"Content of table @TABLE@","latex_data_continued_caption":"Content of table @TABLE@ (continued)","latex_data_label":"tab:@TABLE@-data","latex_null":"\\\\textit{NULL}","mediawiki_structure_or_data":"data","mediawiki_caption":"something","mediawiki_headers":"something","ods_null":"NULL","ods_structure_or_data":"data","odt_structure_or_data":"structure_and_data","odt_relation":"something","odt_comments":"something","odt_mime":"something","odt_columns":"something","odt_null":"NULL","pdf_report_title":"","pdf_structure_or_data":"data","phparray_structure_or_data":"data","sql_include_comments":"something","sql_header_comment":"","sql_compatibility":"NONE","sql_structure_or_data":"structure_and_data","sql_create_table":"something","sql_auto_increment":"something","sql_create_view":"something","sql_procedure_function":"something","sql_create_trigger":"something","sql_backquotes":"something","sql_type":"INSERT","sql_insert_syntax":"both","sql_max_query_size":"50000","sql_hex_for_binary":"something","sql_utc_time":"something","texytext_structure_or_data":"structure_and_data","texytext_null":"NULL","yaml_structure_or_data":"data","":null,"as_separate_files":null,"csv_removeCRLF":null,"csv_columns":null,"excel_removeCRLF":null,"excel_columns":null,"htmlword_columns":null,"json_pretty_print":null,"ods_columns":null,"sql_dates":null,"sql_relation":null,"sql_mime":null,"sql_use_transaction":null,"sql_disable_fk":null,"sql_views_as_tables":null,"sql_metadata":null,"sql_drop_database":null,"sql_drop_table":null,"sql_if_not_exists":null,"sql_truncate":null,"sql_delayed":null,"sql_ignore":null,"texytext_columns":null}'),
(5, 'root', 'server', 'apfsystem', '{"quick_or_custom":"quick","what":"sql","db_select[]":["accidentrecord","ambulance","apfsystem","attendance_system","bbms","bookshop","company","cs192upsms","cybercrimedatabase","database","ecommerce-mary","elimtop","expert","expert2018","frsc_database","frscdb","health","hmsdb","hostel_management_system","intprof","inv_project_db","lmsdb","nafdac","pending","phpmyadmin","project_inv","registration","scheduling","scholardb","scholarship","scholarshipdb","shop","sms","tssmsdb"],"output_format":"sendit","filename_template":"@SERVER@","remember_template":"on","charset":"utf-8","compression":"none","maxsize":"","codegen_structure_or_data":"data","codegen_format":"0","csv_separator":",","csv_enclosed":"\\"","csv_escaped":"\\"","csv_terminated":"AUTO","csv_null":"NULL","csv_structure_or_data":"data","excel_null":"NULL","excel_edition":"win","excel_structure_or_data":"data","htmlword_structure_or_data":"structure_and_data","htmlword_null":"NULL","json_structure_or_data":"data","latex_caption":"something","latex_structure_or_data":"structure_and_data","latex_structure_caption":"Structure of table @TABLE@","latex_structure_continued_caption":"Structure of table @TABLE@ (continued)","latex_structure_label":"tab:@TABLE@-structure","latex_relation":"something","latex_comments":"something","latex_mime":"something","latex_columns":"something","latex_data_caption":"Content of table @TABLE@","latex_data_continued_caption":"Content of table @TABLE@ (continued)","latex_data_label":"tab:@TABLE@-data","latex_null":"\\\\textit{NULL}","mediawiki_structure_or_data":"data","mediawiki_caption":"something","mediawiki_headers":"something","ods_null":"NULL","ods_structure_or_data":"data","odt_structure_or_data":"structure_and_data","odt_relation":"something","odt_comments":"something","odt_mime":"something","odt_columns":"something","odt_null":"NULL","pdf_report_title":"","pdf_structure_or_data":"data","phparray_structure_or_data":"data","sql_include_comments":"something","sql_header_comment":"","sql_compatibility":"NONE","sql_structure_or_data":"structure_and_data","sql_create_table":"something","sql_auto_increment":"something","sql_create_view":"something","sql_procedure_function":"something","sql_create_trigger":"something","sql_backquotes":"something","sql_type":"INSERT","sql_insert_syntax":"both","sql_max_query_size":"50000","sql_hex_for_binary":"something","sql_utc_time":"something","texytext_structure_or_data":"structure_and_data","texytext_null":"NULL","yaml_structure_or_data":"data","":null,"as_separate_files":null,"csv_removeCRLF":null,"csv_columns":null,"excel_removeCRLF":null,"excel_columns":null,"htmlword_columns":null,"json_pretty_print":null,"ods_columns":null,"sql_dates":null,"sql_relation":null,"sql_mime":null,"sql_use_transaction":null,"sql_disable_fk":null,"sql_views_as_tables":null,"sql_metadata":null,"sql_drop_database":null,"sql_drop_table":null,"sql_if_not_exists":null,"sql_truncate":null,"sql_delayed":null,"sql_ignore":null,"texytext_columns":null}');
...
('root', '[{"db":"inv_project_db","table":"invoice_details"},{"db":"inv_project_db","table":"invoice"},{"db":"scholardb","table":"users"},{"db":"inv_project_db","table":"products"},{"db":"project_inv","table":"invoice_details"},{"db":"tssmsdb","table":"users"},{"db":"tssmsdb","table":"bankdetails"},{"db":"tssmsdb","table":"notification"},{"db":"project_inv","table":"user"},{"db":"inv_project_db","table":"user"}]');
